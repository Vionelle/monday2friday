                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5 mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="inputRepeatPassword" type="password" name="repeatPassword" placeholder="Password" />
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                    ...
                                    <input type="submit" class="btn btn-dark" name="submit" value="Reset Password"/>
                                </div>
                            </form>
                        </div>
                    </div>
